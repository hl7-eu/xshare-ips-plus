The xShare IPS+ Implementation Guide is produced by the xShare project. Except where otherwise stated, the original text and artifacts created by the xShare project for this guide are made available under the Creative Commons CC0 1.0 Universal Public Domain Dedication ("No Rights Reserved").
...
The following non-exhaustive list identifies commonly referenced third-party terminology and standards sources that may require separate license review:

| Terminology or standard | Owner or steward | License or access information |
| --- | --- | --- |
| SNOMED CT | SNOMED International | <https://www.snomed.org/snomed-ct/get-snomed-ct> |
| LOINC | Regenstrief Institute, Inc. and the LOINC Committee | <https://loinc.org/license/> |
| UCUM | Regenstrief Institute, Inc. and the UCUM Organization | <http://unitsofmeasure.org/trac/wiki/TermsOfUse> |
| NCI Thesaurus and NCI EVS terminology content | U.S. National Cancer Institute | <https://evs.nci.nih.gov/> |
| ICD classification system | World Health Organization (WHO) | <https://www.who.int/about/policies/publishing/copyright> |
| ATC classification system | WHO Collaborating Centre for Drug Statistics Methodology | <https://www.whocc.no/use_of_atc_ddd/> |
...
| DICOM | National Electrical Manufacturers Association (NEMA) | <https://www.dicomstandard.org/about> |
