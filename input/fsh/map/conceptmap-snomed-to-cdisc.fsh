...
* targetUri = "https://www.cdisc.org/standards/terminology/controlled-terminology"
...
* group[0].element[0].target[0].code = #C64432
...
* group[0].element[1].target[0].code = #C64433
...
* group[0].element[2].target[0].code = #C64467
